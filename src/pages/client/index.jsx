...
export default function Client(props) {
    ...
    useEffect(() => {
      if (router.query.id) {
        ...
        fetch(`${process.env.NEXT_PUBLIC_BASE}/client?id=${router.query.id}`)
    ...
    async function handleSave() {
      try {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_BASE}/client${router.query.id ? '?id='+router.query.id : ''}`, {
          method: 'POST',
          headers: {
